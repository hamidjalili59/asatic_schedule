...
///
class CreateAdminUseCase extends UseCase<ReturnSaveFuncInfo<AdminResponse>,
    ModelWithParentId<Admin>> {
  ///
  ...
  @override
  Future<ReturnSaveFuncInfo<AdminResponse>> call(
    ModelWithParentId<Admin>? param,
  ) async {
    if (param == null) {
