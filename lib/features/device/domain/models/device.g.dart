...
int _deviceEstimateSize(
  ...
  {
    final value = object.counterList;
    if (value != null) {
...
void _deviceSerialize(
  ...
  writer.writeLongList(offsets[0], object.counterList);
...
Device _deviceDeserialize(
  ...
  final object = Device(
    counterList: reader.readLongList(offsets[0]),
    id: id,
...
extension DeviceQueryFilter on QueryBuilder<Device, Device, QFilterCondition> {
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'counterList',
      ));
    });
  }

  QueryBuilder<Device, Device, QAfterFilterCondition> counterListIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'counterList',
        0,
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'counterList',
        0,
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Device, Device, QAfterFilterCondition> counterListLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DeviceQueryWhereDistinct on QueryBuilder<Device, Device, QDistinct> {
  QueryBuilder<Device, Device, QDistinct> distinctByCounterList() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'counterList');
    });
  }
...
extension DeviceQueryProperty on QueryBuilder<Device, Device, QQueryProperty> {
  ...
  QueryBuilder<Device, List<int>?, QQueryOperations> counterListProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'counterList');
    });
  }
